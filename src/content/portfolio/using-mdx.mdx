...
pubDate: 'Jun 01 2024'
heroImage: '../../assets/Location8.webp'
---
...
Here is how you can use MDX to create interactive content with embedded components.
MDX allows you to mix Markdown with JSX components for rich, interactive documentation.
